...
/**
 * BaseRSAJwtTokenProvider.java
 * TODO(rguillemette) Add description.
 *
 * @author rguillemette
 * @since 2.0.0 - Mar 18 - 2019
 */
public abstract class BaseRSAJwtTokenProvider implements TokenProvider {

    protected String keyId = null;

    protected RSASSASigner rsaSigner = null;
     ...
     */
    @Autowired
    public BaseRSAJwtTokenProvider(KeysProvider pKeysProvider, ServerInfo pServerInfo) throws JOSEException {
