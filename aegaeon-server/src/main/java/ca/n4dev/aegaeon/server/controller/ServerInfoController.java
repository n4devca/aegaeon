...
public class ServerInfoController {
    ...
    public ServerInfoResponse configuration(HttpServletRequest pHttpServletRequest) {
        ...
        List<ScopeView> allScopes = this.scopeService.findAll();
...
//                                                     FlowFactory.PARAM_CLIENTCREDENTIALS));
        ...
        info.setResponseTypesSupported(Arrays.asList(FlowUtils.RTYPE_AUTH_CODE,
                                                     FlowUtils.RTYPE_IMPLICIT_FULL,
                                                     FlowUtils.RTYPE_IMPLICIT_ONLYID));
