...
public class SimpleUserAccountController extends BaseUiController {
    ...
    private ModelAndView createUserView(Long pUserId, Locale pLocale) {
        return createUserView(this.userService.findOne(pUserId), pLocale);
    }
    
    private ModelAndView createUserView(UserView pUser, Locale pLocale) {
...
//                userInfoDto.setCode(type.getName());
//                userInfoDto.setLabelName(getLabel("entity.userinfotype." + type.getName(), pLocale));
//                userInfoDto.setParentCode(parent.getCode());
//                
//                if (type.getName().contains("OTHER")) {
//                    userInfoDto.setOtherInfo(true);
//                }
//                
//                // User Values
//                UserInfoView userValue = Utils.find(pUserInfos, 
//                        ui -> ui.getName().equals(type.getName()) && Utils.equals(ui.getCategory(), type.getCategory()));
//                
//                if (userValue != null) {
//                    userInfoDto.setValue(userValue.getValue());
//                }
//                
//                parent.addUserInfoTypeDto(userInfoDto);
